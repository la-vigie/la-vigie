---
name: ship
description: Create a PR, sync the task, and mark it done — the full ship flow with a blocking fresh-context review gate. Tracker writes go through the repo's task-provider (skipped if none).
targets: ["*"]
claudecode:
